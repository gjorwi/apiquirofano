...
async function connectDB() {
  const uri = process.env.MONGODB_URI || 'mongodb://localhost:27017/quirofanodb';
...
// ─── CASOS QUIRÚRGICOS ────────────────────────────────────────────────────────
const casos = [
  { _id: 'c1', tipo: 'electivo', prioridad: 'alta', estado: 'pendiente', paciente: 'p1', especialistaPrincipal: 'e1', equipoQuirurgico: ['e6'], diagnostico: 'd2', procedimiento: 'pr2', duracionEstimadaMin: 80, observaciones: 'Paciente con historial de diabetes, requiere evaluación preoperatoria completa.', plan: null, createdAt: '2026-05-10T08:30:00Z' },
  { _id: 'c2', tipo: 'electivo', prioridad: 'media', estado: 'pendiente', paciente: 'p3', especialistaPrincipal: 'e4', equipoQuirurgico: [], diagnostico: 'd3', procedimiento: 'pr3', duracionEstimadaMin: 90, observaciones: 'Primera cirugía programada de hernia.', plan: null, createdAt: '2026-05-11T10:00:00Z' },
  { _id: 'c3', tipo: 'electivo', prioridad: 'baja', estado: 'aprobada', paciente: 'p5', especialistaPrincipal: 'e6', equipoQuirurgico: ['e1'], diagnostico: 'd8', procedimiento: 'pr8', duracionEstimadaMin: 110, observaciones: '', plan: null, createdAt: '2026-05-08T14:20:00Z' },
  { _id: 'c4', tipo: 'electivo', prioridad: 'alta', estado: 'programada', paciente: 'p2', especialistaPrincipal: 'e2', equipoQuirurgico: ['e1', 'e5'], diagnostico: 'd5', procedimiento: 'pr5', duracionEstimadaMin: 240, observaciones: 'Requiere UCI postoperatoria reservada.', plan: 'pl1', createdAt: '2026-05-05T09:00:00Z' },
  { _id: 'c5', tipo: 'electivo', prioridad: 'media', estado: 'programada', paciente: 'p7', especialistaPrincipal: 'e4', equipoQuirurgico: [], diagnostico: 'd4', procedimiento: 'pr4', duracionEstimadaMin: 120, observaciones: 'Paciente con prótesis dental, notificar a anestesiología.', plan: 'pl2', createdAt: '2026-05-07T11:15:00Z' },
  { _id: 'c6', tipo: 'electivo', prioridad: 'alta', estado: 'en_admision', paciente: 'p6', especialistaPrincipal: 'e3', equipoQuirurgico: ['e1'], diagnostico: 'd6', procedimiento: 'pr6', duracionEstimadaMin: 200, observaciones: 'Paciente con hipertensión controlada.', plan: 'pl3', createdAt: '2026-05-01T07:30:00Z' },
  { _id: 'c7', tipo: 'electivo', prioridad: 'media', estado: 'en_curso', paciente: 'p4', especialistaPrincipal: 'e5', equipoQuirurgico: [], diagnostico: 'd7', procedimiento: 'pr7', duracionEstimadaMin: 150, observaciones: '', plan: 'pl4', createdAt: '2026-05-03T08:00:00Z' },
  { _id: 'c8', tipo: 'electivo', prioridad: 'baja', estado: 'finalizado', paciente: 'p8', especialistaPrincipal: 'e1', equipoQuirurgico: [], diagnostico: 'd3', procedimiento: 'pr3', duracionEstimadaMin: 90, observaciones: 'Sin complicaciones.', plan: 'pl5', createdAt: '2026-04-28T09:00:00Z' },
  { _id: 'c9', tipo: 'electivo', prioridad: 'baja', estado: 'rechazada', paciente: 'p1', especialistaPrincipal: 'e6', equipoQuirurgico: [], diagnostico: 'd9', procedimiento: 'pr9', duracionEstimadaMin: 90, observaciones: 'Rechazada por falta de documentación.', plan: null, createdAt: '2026-05-09T12:00:00Z' },
  { _id: 'c10', tipo: 'electivo', prioridad: 'media', estado: 'cancelado', paciente: 'p2', especialistaPrincipal: 'e1', equipoQuirurgico: [], diagnostico: 'd1', procedimiento: 'pr1', duracionEstimadaMin: 60, observaciones: 'Cancelado por solicitud del paciente.', plan: null, createdAt: '2026-05-06T10:00:00Z' },
  { _id: 'c11', tipo: 'emergencia', prioridad: 'alta', estado: 'en_admision', paciente: 'p3', especialistaPrincipal: 'e1', equipoQuirurgico: ['e5'], diagnostico: 'd1', procedimiento: 'pr1', duracionEstimadaMin: 60, observaciones: 'Ingresó con dolor abdominal agudo en FID, cuadro compatible con apendicitis perforada.', fechaIngresoEmergencia: '2026-05-21T03:15:00Z', motivoEmergencia: 'Apendicitis perforada', plan: 'pl6', createdAt: '2026-05-21T03:30:00Z' },
  { _id: 'c12', tipo: 'emergencia', prioridad: 'alta', estado: 'en_curso', paciente: 'p6', especialistaPrincipal: 'e2', equipoQuirurgico: ['e3'], diagnostico: 'd5', procedimiento: 'pr5', duracionEstimadaMin: 240, observaciones: 'IAM con compromiso hemodinámico. Requiere revascularización urgente.', fechaIngresoEmergencia: '2026-05-21T05:40:00Z', motivoEmergencia: 'Infarto agudo de miocardio', plan: 'pl7', createdAt: '2026-05-21T05:50:00Z' },
  { _id: 'c13', tipo: 'emergencia', prioridad: 'alta', estado: 'finalizado', paciente: 'p8', especialistaPrincipal: 'e3', equipoQuirurgico: [], diagnostico: 'd6', procedimiento: 'pr6', duracionEstimadaMin: 180, observaciones: 'TCE severo, hematoma epidural.', fechaIngresoEmergencia: '2026-05-18T22:10:00Z', motivoEmergencia: 'Traumatismo craneoencefálico', plan: 'pl8', createdAt: '2026-05-18T22:20:00Z' },
];
...
// ─── USUARIOS ─────────────────────────────────────────────────────────────────
const usuarios = [
  { _id: 'u1', nombre: 'Admin Principal',     username: 'admin',       password: bcrypt.hashSync('admin123', 10), rol: 'administrador', especialistaId: null, activo: true },
  { _id: 'u2', nombre: 'Dr. Andrés Montoya',  username: 'dr.montoya',  password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e1', activo: true },
  { _id: 'u3', nombre: 'Dra. Carmen Solís',   username: 'dr.solis',    password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e2', activo: true },
  { _id: 'u4', nombre: 'Dr. Felipe Rojas',    username: 'dr.rojas',    password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e3', activo: true },
  { _id: 'u5', nombre: 'Dra. Valentina Cruz', username: 'dr.cruz',     password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e4', activo: true },
  { _id: 'u6', nombre: 'Dr. Hernán Palacios', username: 'dr.palacios', password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e5', activo: true },
  { _id: 'u7', nombre: 'Dra. Isabel Vargas',  username: 'dr.vargas',   password: bcrypt.hashSync('pass123', 10),  rol: 'especialista',  especialistaId: 'e6', activo: true },
  { _id: 'u8', nombre: 'Enf. Rosa Jiménez',   username: 'admision1',   password: bcrypt.hashSync('pass123', 10),  rol: 'admision',      especialistaId: null, activo: true },
  { _id: 'u9', nombre: 'Enf. Pedro Acosta',   username: 'admision2',   password: bcrypt.hashSync('pass123', 10),  rol: 'admision',      especialistaId: null, activo: true },
];
